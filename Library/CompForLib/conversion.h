...
#define CONVERSION_H
	/*
	Class that handles conversion from String^ to numeric and vica versa.
	...
	*/
	...
	public:
		...
		static std::string convertConstCharToSTDString(const char* characters);
		//convert const char to String ^
		static String ^convertConstCharToString(const char* characters);
	private:
		//default constructor
		Conversion();
		//destructor
