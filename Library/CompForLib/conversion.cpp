...
namespace ComputationalForensics {
	...
	*/
	...
	/*
	Converts value of type const char* to std::string.
	---------------------------------------------------------
	@param characters: const char* - Value to convert to std::string
	@return: std::string - The converted value
	*/
	std::string Conversion::convertConstCharToSTDString(const char* characters) {
		if(characters != nullptr) {
			string stdString(characters);
			return stdString;
		} else if(characters == "") {
			return "";
		} //if
		return "<undefined value>";
	} //convertConstCharToSTDString

	/*
	Converts value of type const char* to String^.
	---------------------------------------------------------
	@param characters: const char* - Value to convert to String^
	@return: String^ - The converted value
	*/
	String ^Conversion::convertConstCharToString(const char* characters) {
		string stdString = "";
		String ^convertedString = "";
		stdString = convertConstCharToSTDString(characters);
		convertedString = gcnew String(stdString.c_str());
		return convertedString;
	} //convertConstCharToString
} //namespace